...
Game.Launch=function()
{
	...
	'<div class="listing">CHUNGUS Clicker (Cookie Clicker) is a javascript game by <a href="http://orteil.dashnet.org" target="_blank">Orteil</a> and <a href="http://dashnet.org" target="_blank">Opti</a>.</div>'+
	...
	Game.Init=function()
	{
		...
		Game.bakeryNameRefresh=function()
		{
			...
			if (name.slice(-1).toLowerCase()=='s') name+='\' bakery'; else name+='\'s chungus machine';
		...
		Game.attachTooltip(l('topbarDiscord'),'<div style="padding:8px;width:250px;text-align:center;">COCK Clicker official discord server.<br>You can share tips and questions about Cookie Clicker and all our other games!</div>','this');
		Game.attachTooltip(l('topbarPatreon'),'<div style="padding:8px;width:250px;text-align:center;">go support the ORIGINAL creator on Patreon and help them keep updating Cookie Clicker!<br>There\'s neat rewards for patrons too!</div>','this');
		...
		Game.getNewTicker=function(manual)//note : "manual" is true if the ticker was clicked, but may also be true on startup etc
		{
			...
			if (list.length==0)
			{
				if (Game.cookiesEarned<5) list.push('oh NO!!! " Chungus" Needs to make " BABY" (baby chu,ngus) ');
				else if (Game.cookiesEarned<50) list.push('"chungus" (fat bugs bunny) is starting to produce BABY');
				else if (Game.cookiesEarned<100) list.push('PEOPLE are staring to adopt some BABY "chungus"');
				...
				else if (Game.cookiesEarned<1000000) list.push('"PEOPLE" from DISTANT LANDS are talking about " CHUNGUS".');
